        ...
        <Card>
          <CardContent>
            <Row>
              ...
              <Col>
                <h4> Patient Details</h4>  <Alert variant="primary">
                  Personal Details!
                </Alert>
              </Col>
            </Row>
                ...
                <Form>
                  ...
                  <Form.Group as={Row} className="mb-3 justify-content-md-center" controlId="formPlaintextEmail">
                    ...
                    <Col sm="7">
                      ...
                      <div  className="dd" style={{display:'flex',flexDirection:'row',alignItems:'center',justifyContent:'center',alignContent:'center',alignSelf:''}}>
                        <Button style={{ background: "#e2e2e2" }}>One</Button>
                        <Button >Two</Button>
                        <Button>Three</Button>
